    ...
    <div class="music_play" >
        ...
        <div class="icon">
           ...
           <div class="icon_control">
                ...
                <i @click="beforeSong()" class="material-icons">fast_rewind</i>
             
                <i style="margin: 10px" id="btn-play" v-if="!isPlay" @click="btn_play" class="material-icons">play_arrow</i>
                <i style="margin: 10px" v-else @click="btn_play" class="material-icons">pause</i>
               
                <i @click="afterSong()" class="material-icons">fast_forward</i>
                <i class="fa fa-usb"></i>
           </div>
        ...
        <audio id="audio" :src="newSong.mp3" type="audio/mpeg" loop></audio>
    </div>
</template>
